<?php
    ...
    $there_are_goods_with_vat = false;
    $there_are_goods_without_vat = false;
    foreach ($goods as $i => $article){
        if ($article['Vat'] == 20){
            $there_are_goods_with_vat = true;
        };
        if ($article['Vat'] != 20){
            $there_are_goods_without_vat = true;
        }
    }
...
<BODY TEXT="#000000">
<? if($there_are_goods_without_vat){ ?>
...
?>
		<TR>
			<TD STYLE="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" HEIGHT=14 ALIGN=CENTER SDVAL="1" SDNUM="1058;"><FONT><?=($row)?></FONT></TD>
...
<TABLE FRAME=VOID CELLSPACING=0 COLS=10 RULES=NONE style="border: none">
    ...
    <TR>
        <TD COLSPAN=8 HEIGHT=21 ALIGN=CENTER><B><FONT SIZE=3><?php
                    ...
                    ?> № РН-<?=sprintf("%07d",$order['Ord_id'])?>/1</FONT></B></TD>
        <TD ALIGN=LEFT><BR></TD>
        <TD ALIGN=LEFT><BR></TD>
    </TR>
    <TR>
    ...
    foreach ($goods as $k=>$v):
        ...
        $row++;
        //$price_no_vat = round(100*$v['Price']/(100 + $article['Vat']),2);
    ...
    */
        ...
        <TR>
            ...
            <TD STYLE="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" ALIGN=CENTER><?php if ($v['Name'] == 'Доставка') echo 'посл.'; else echo 'шт.'; ?></TD>
            <TD STYLE="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" ALIGN=CENTER><FONT><?=number_format($v['Qty'], 2, ',', ' ')?></FONT></TD>
            <TD STYLE="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" ALIGN=CENTER><FONT><?=number_format($price_without_vat, 2, ',', ' ')?></FONT></TD>
            <TD STYLE="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" ALIGN=CENTER SDVAL="57" SDNUM="1058;"><FONT><?=number_format($summ_without_vat, 2, ',', ' ')?></FONT></TD>
            <TD STYLE="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" ALIGN=CENTER><FONT><?=number_format($summ_vatt, 2, ',', ' ')?></FONT></TD>
        </TR>
    <?php
    endforeach;
